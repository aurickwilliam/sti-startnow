...
class MainProfileEditPage extends StatefulWidget {
  final String profileImg;
  final String coverImg;

  const MainProfileEditPage({
    super.key,
  ...
  @override
  State<MainProfileEditPage> createState() => _MainProfileEditPageState();
}

class _MainProfileEditPageState extends State<MainProfileEditPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // Choosing the parent widget based on the orientation
