...
knowledge_base = {
    ...
    ("how does the enrollment process for irregular students work", "irregular student enrollment"): (
        "Here are the steps to proceed with the enrollment using our application:\n"
        "- Go to the Main Dashboard and click on the ‘Enroll Now’ button.\n"
    ...
    ("available courses", "what courses are available", "list of courses"):  (
    ...
    ("when do classes start", "class schedule", "first day of class"): "Classes officially starts on September 1. Your class schedule is visible on your account page after your enrollment is successful.",
